...
class SimplyticsErrorTag extends SimplyticsErrorInformationProperty {
  /// Creates a tag with the "name" and the "value" for reporting to the error monitoring system.
  SimplyticsErrorTag(String name, Object value)
